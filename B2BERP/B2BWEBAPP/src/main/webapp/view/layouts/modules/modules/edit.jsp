...
<form id="newModuleCreationform" method="post" novalidate style="margin:0;padding:20px 20px">
    <table id='newModuleCreationformTable' style="width: 100%">
        ...
        <tr> 
            ...
            <td><input name="hasChildren" class="easyui-switchbutton" data-options="onText:'Yes',offText:'No'" required="true" style="width:100%;height: 30px;"></td>
            <td>Module IS Active : </td>
            <td><input name="active" class="easyui-switchbutton" data-options="onText:'Yes',offText:'No'" required="true" style="width:100%;height: 30px;"></td>
        </tr>
        <tr> 
            <td>Module Priority : </td>
            <td><input name="priorityIndex" class="easyui-numberbox" data-options="min:0,precision:2" required="true" style="width:100%;height: 30px;"></td>
            <td>Module Parent : </td>
            <td>
                <input name="parent" class="easyui-combotree" data-options="url:'domainapi/modulestreecombo',method:'get',label:'Select Parent',labelPosition:'top'"required="true" style="width:100%;height: 30px;">
            </td>
        </tr>
    </table>
</form>
...
<div id="dlg-buttons">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="" style="width:90px">Cancel</a>
</div>
<style>
